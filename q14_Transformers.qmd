...
C'est un article intitulé "Attention is all you need" de @vaswani_attention_2017 qui est le germe d'une véritable révolution des modèles de langage. IL propose une solution pour prendre en compte les relations qui existent entre les différents termes d'un séquence de terme. 
...
## Les variations de bert

### le réentrainement

### Ajuster à des nouvelles tâches
