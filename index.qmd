...
A mesure que ces données prolifèrent, des méthodes pour les analyser se sont développées à grande vitesse, moins pour des motivations d'études que pour répondre à des besoins opérationnels. Les développements du NLP viennent de la nécessité de répondre à des problèmes opérationnels.

Ils offrent cependant de nouvelles ressources pour l'approche analytique

## Le but de l'ouvrage

Ce e-book est le syllabus d'un cours que nous dispensons sous différents formats et avec différents degré d'approfondissement. Il fait l'inventaire des méthodes les plus courantes incluant le développement des embeddings.

Il a une vocation pratique , des cas, des codes.

## Les contributeurs :

Le contenu doit tant par les données, les idées, les codes, à plusieurs personnes en particulier. On citera par ordre chronologique
...
On ne peut en produire la liste exhaustives, mais plusieurs générations d'étudiants ont contribué à ce travail en explorant un certains nombre de jeux de données proposés ici.
...
Voici les raisons qui organisent le cours en 14 chapitres

1.  Préambule ( ce que vous êtes en train de lire !)

2.  Chapitre 1 : une réflexion et une introduction à la linguistique, car le calcul ne suffit pas à se substituer à plus de 2000 ans de réflexions sur la langues, et au cours des deux derniers siècle à la clarification de questions essentielles.
...
6.  Chapitre 7 : Analyse quantitative du corpus

7.  Chapitre 8 : Tokenisation et dtm

8.  Chapitre 9 : Analyse des co-occurences

9.  Chapitre 10 : au début il y avait l'analyse factorielle

10. Chapitre 11 : SVD et LSA :

11. Chapitre 12 : Topic model

12. Chapitre13 : Supervised modeling

13. Chapitre 14 : word2vec to doc2vec

14. Chapitre 15 : transformers

15. Chapitre 16 : tasks , Zsl, abstracting

16. chapitre 17 : generative models , un monde à inventer

17. chapitre 18 : Perspectives : un melting pot de question

## Data sets

On s'appuiera sur des data test "réél" et publics
